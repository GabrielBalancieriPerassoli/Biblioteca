<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM autor WHERE idautor LIKE '%$data%' or nome_autor LIKE '%$data%' ORDER BY idautor DESC";

    }
    else
    {
        $sql = "SELECT * FROM autor ORDER BY idautor DESC";
    }
...
<html lang="en">
        ...
        <div class="content-container">
            <div class="table-container">
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    echo '<tr>';
                    echo '<td>' . $user_data['idautor'] . '</td>';
                    echo '<td>' . $user_data['nome_autor'] . '</td>';
                    echo '<td>
                        <a class="btn btn-sm btn-info btn-group" href="edit_autor.php?idautor=' . $user_data['idautor'] . '">
    ...
    <script>
            ...
            function searchData()
            {
                window.location = 'pesquisa_autor.php?search='+search.value;
            }
    </script>
