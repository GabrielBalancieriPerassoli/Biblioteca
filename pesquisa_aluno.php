<?php
    ...
    {
        $data = $_GET['search'];
        $sql = "SELECT * FROM aluno WHERE idaluno LIKE '%$data%' or nome_aluno LIKE '%$data%' or cpf LIKE '%$data%' or ra LIKE '%$data%' ORDER BY idaluno DESC";
...
<html lang="en">
        ...
        <div class="content-container">
            <div class="table-container">
                ...
                while ($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td>
                        <a class="btn btn-sm btn-info btn-group" href="edit_aluno.php?idaluno=' . $user_data['idaluno'] . '">
    ...
    <script>
            ...
            function searchData()
            {
                window.location = 'pesquisa_aluno.php?search='+search.value;
            }
    </script>
