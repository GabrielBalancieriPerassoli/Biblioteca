...
<html lang="en">
    ...
    <body class= "corpo">
        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-item nav-link active" href="exemplar_html.php">Cadastrar Exemplar</a>
                </div>
            </div>
            <div>
    ...
    <body>
        ...
        <div>
            <a href="autor_html.php" class="btn btn-outline-danger btn-voltar">🠔 Voltar</a>
        </div>
        ...
        <div class = "container">
            <div class = "tela-cadastro">
                ...
                <form action="cadastro_exemplar.php" method="POST">
                    ...
                    <h2>Cadastrar Exemplar Livro</h2>
                    <br><br>
                    <h4>Exemplar</h4>
                    <input autofocus autocomplete = "off" type = "text" class="exemplar" name="numero_exemplar" placeholder = "Número Exemplar" required>
                    ...
                    <br><br>
                    <input type="submit" class="cadastrar" name="cadastrar_exemplar" value="Cadastrar Dados">
            ...
            <div>
                ...
                <a href="aluno_html.php" class="btn btn-danger btn-lg btn-proximo">Próximo ➜</a>
